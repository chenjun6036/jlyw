...
//				collapsible:true,
		...
		function query(){
			$('#table6').datagrid('options').url='/jlyw/CrmServlet.do?method=34';
...
<DIV class="JlywMainLayoutDiv">
	<DIV class="JlywTopLayoutDIV">
		<jsp:include page="/Common/Title.jsp" flush="true">
			<jsp:param name="TitleName" value="同比环比查询" />
		</jsp:include>
	</DIV>
	<form id="frm_export" method="post" action="/jlyw/CrmExportServlet.do?method=8">
