    ...
    <script type="text/javascript" src="../../JScript/upload.js"></script>
		...
		function sub(){
			$('#frm_edit').form('submit',{
				url: '/jlyw/CrmServlet.do?method=3',
...
<DIV class="JlywMainLayoutDiv">
	<DIV class="JlywTopLayoutDIV">
		<jsp:include page="/Common/Title.jsp" flush="true">
			<jsp:param name="TitleName" value="记录处理结果" />
		</jsp:include>
	</DIV>
...
<div id="edit" class="easyui-window" title="记录处理结果" style="padding: 10px;width: 755px;height: 520px;"
		iconCls="icon-edit" closed="true" maximizable="false" minimizable="false" collapsible="false" modal="true">
<form id="frm_show" method="post">
	<table  id="table2" style="width:700px; height:230px; padding-top:10px; padding-left:20px" class="easyui-panel" title=" ">
		<tr >
			<td align="center">投诉人所属单位：</td>
			<td align="left" >
			<input id="customerName" name="CustomerName" type="text" readonly="readonly" style="width:220px" class="easyui-validatebox" "/>
			</td>
			<td align="right">投&nbsp;&nbsp;诉&nbsp;&nbsp;人：</td>
			<td align="left" ><input id=customerContactorName name="CustomerContactorName" readonly="readonly" type="text" class="easyui-validatebox" /></td>
		</tr>
		<!-- <tr>
		...
		<tr>
			...
			<td align="left">
			<input name="CustomerRequiredTime" readonly="readonly" id="customerRequiredTime" type="text"  />
			</td>
		...
		<tr >
			...
			<td align="left" >
			<input id="handleMan" style="border:none;" readonly="readonly" name="HandleMan" type="text" class="easyui-validatebox" />
			</td>
		...
		<tr >
			...
			<td align="left" >
			<textarea id="feedback" name="Feedback" readonly="readonly" cols="25" rows="4"></textarea> </td>
			<td align="right">处理办法：</td>
			<td align="left" >
			<textarea id="method" name="Method" readonly="readonly" cols="25" rows="4"></textarea> 
			</td>
			</td>
		</tr>
		<!-- <tr>
            <td align="right">处&nbsp;理&nbsp;负&nbsp;责&nbsp;人：</td>
			<td align="left" >
			<input id="handleMan" style="border:none;" name="HandleMan" type="text" class="easyui-validatebox" />
			</td>
			<td align="right">工号：</td>
		<td align="left"><input id="jobNum" name="JobNum" style="border:none; width:150px"/>
		</td>
		</tr> -->
	</table>
	</form>
	...
	<table style="width:700px; height:100px; padding-top:10px; padding-left:20px" class="easyui-panel" title="">
		...
		<td align="right">实际完成时间：</td>
			...
			<input class="easyui-datebox" name="ActulEndTime" id="actulEndTime" required="true" type="text"  />
			</td>
		</tr>
		<tr >
			<td align="right">投诉结果：</td>
			<td align="left"  colspan="3"><textarea id="remark" name="Remark" class="easyui-validatebox" cols="55" rows="4" required="true"></textarea> 
