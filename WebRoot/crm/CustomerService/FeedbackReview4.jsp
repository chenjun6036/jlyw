    ...
    <script type="text/javascript" src="../../JScript/upload.js"></script>
		...
		function sub(){
			$('#frm_edit').form('submit',{
				url: '/jlyw/CrmServlet.do?method=43',
		...
		$('#table1').datagrid({
				...
				queryParams:{'Status':encodeURI('3')},
				sortName:'Id',
				sortOrder:'asc',
				remoteSort: false,
				idField:'Id',
				...
				columns:[[
					...
					formatter:function(value,rowData,rowIndex){
							...
							{
								rowData['Status']=3; return "已处理";
							}
							else if(value == 4|| value == '4')
							{
								rowData['Status']=4; return "已结束";
							}
							else if(value == 5|| value == '5')
							{
								rowData['Status']=5; return "已回访";
							}
						}} */
...
<DIV class="JlywMainLayoutDiv">
	<DIV class="JlywTopLayoutDIV">
		<jsp:include page="/Common/Title.jsp" flush="true">
			<jsp:param name="TitleName" value="分析处理意见" />
		</jsp:include>
	</DIV>
