...
function doLoadCommissionSheet(){	//查找委托单
	$("#SearchForm").form('submit', {
		url:'/jlyw/CommissionSheetServlet.do?method=20',
		onSubmit: function(){
				// do some check
...
function updatecomSheet()	//委托单修改
{
	$("#CommissionSheetForm").form('submit', {
		url:'/jlyw/CommissionSheetServlet.do?method=19',
		onSubmit: function(){
				// do some check
				// return false to prevent submit;
		...
		success:function(data){
			...
			if(result.IsOK){
				...
				$.messager.alert("提示","委托单修改成功！","info");
				//var result1 = confirm("委托单修改成功，是否打印委托单？");
				/*if(result1 == false){
					return false;
				}			
...
function doPrintCommissionSheet(){
	if(JSONobjPrint==null){
		$.messager.alert('提示','还未修改委托单，不能打印','error');
	}else{
...
<DIV class="JlywMainLayoutDiv">
	<DIV class="JlywTopLayoutDIV">
		<jsp:include page="/Common/Title.jsp" flush="true">
			<jsp:param name="TitleName" value="委托单修改" />
		</jsp:include>
	</DIV>
	  ...
	  <div id="p" class="easyui-panel" style="width:1005px;padding:10px;"
		 ...
		 <div class="easyui-panel" style="width:1005px; margin:0px; padding:0px" title="新建委托单">
			...
			<table width="1000px" id="table1">
				<tr>
				  ...
				  <td width="187"  align="left"><select name="CommissionType" style="width:152px" readonly="readonly" >
				  ...
				  <td width="171"  align="left"><input name="CommissionDate" id="CommissionDate" type="text"  /></td>
					<td width="64"  align="right">承诺日期:</td>
				    <td width="168"  align="left"><input name="PromiseDate" id="PromiseDate" class="easyui-datebox"  type="text" /></td>
		...
		<table id="table4" width="1000px" style="margin-top:20px">
			<tr align="center" >
                ...
                <td align="center" colspan="2">
					<a href="javascript:void(0)" class="easyui-linkbutton" icon="icon-add" name="Add" onclick="updatecomSheet()" title="修改委托单！">修改委托单</a>
			  </td>
                <td align="center" colspan="2">
				    <a href="javascript:void(0)" class="easyui-linkbutton" icon="icon-print" name="print" onclick="doPrintCommissionSheet()" title="打印修改后的预留委托单！">打印委托单</a>
				</td>
