...
<DIV class="JlywMainLayoutDiv">
	...
	<div id="fee_assign_window" class="easyui-window" closed="true" modal="true" title="产值分配" collapsible="false" minimizable="false" maximizable="false" iconCls="icon-save" style="width:550px;height:460px;padding:5px;">
		<div class="easyui-layout" fit="true">
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
