...
// 			sortOrder: 'desc',
			...
			toolbar:[{
				...
				handler:function(){
					...
					if(row == null){
						$.messager.alert('提示',"请先选择证书！",'info');
						return false;
					}
					if(row.CertificatePdf == ""){
						$.messager.alert('提示',"该证书尚未生成正式版本！",'info');
						return false;
					}
...
<DIV class="JlywMainLayoutDiv">
	<DIV class="JlywTopLayoutDIV">
		<jsp:include page="/Common/Title.jsp" flush="true">
			<jsp:param name="TitleName" value="下载证书Word文件" />
		</jsp:include>
	</DIV>
		...
		<form id="SearchForm" method="post" >
			<table width="850px" id="table1">
				<tr >
					...
					<td width="25%"  align="center"><a class="easyui-linkbutton" iconCls="icon-search" href="javascript:void(0)" onClick="doLoadCommissionSheet()">查询</a>&nbsp;&nbsp;<a class="easyui-linkbutton" iconCls="icon-undo" href="javascript:history.go(-1)">返回</a></td>
