...
%>
	...
	<div style="line-height:20px" align="center">
		<table style="background-color:#FFFFFF">
			<TR>
				<td align="center">
					<STRONG>
							<font color="#000000" size="5">已结账业务打印</font>
					</STRONG>
				</td>
			</TR>
		</table>
	...
	<div id="div1" style="background-color: #FFFFFF; color:#FFFFFF" >
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<TR>
				<TD width="30%" align="left" style="padding-left:20px"><font size="2" color="#000000">统计时间：<%=ret.getString("DateFrom") %></font></TD>
				<TD width="5%" align="center"><font size="2" color="#000000">至</font></TD>
				<TD width="30%" align="left"><font size="2" color="#000000"><%=ret.getString("DateEnd") %></font></TD>
				<TD width="30%" align="right"><font size="2" color="#000000">打印日期：<%=ret.getString("PrintDate") %></font></TD>
			</TR>
			<TR>
				<TD width="35%" align="left" style="padding-left:20px" colspan="2"><font size="2" color="#000000">结账人工号：<%=ret.getString("UserJobNum") %>&nbsp;&nbsp;&nbsp;&nbsp;<%=ret.getString("UserName") %></font></TD>
	...
	<div id="div2">
		<table border=1 cellSpacing=0 cellPadding=1 width="100%" style="border-collapse:collapse;table-layout:fixed;" bordercolor="#000000">
			<thead>
				<tr height="25px">
					<td width="12%" align="center"><font size="2">清单号</font></td>
					<td width="12%" align="center"><font size="2">总计费用</font></td>
					<td width="12%" align="center"><font size="2">现金支付</font></td>
					<td width="12%" align="center"><font size="2">支票支付</font></td>
					<td width="16%" align="center"><font size="2">预付款支付</font></td>
					
					<td width="12%" align="center"><font size="2">结账人</font></td>					
					<td width="12%" align="center"><font size="2">结账时间</font></td>
					<td width="12%" align="center"><font size="2">发票号</font></td>
	...
	<script language="javascript" type="text/javascript">
		...
		function Mytable(){
			...
			LODOP.ADD_PRINT_TEXT(55,310,400,30,"结账统计表");
