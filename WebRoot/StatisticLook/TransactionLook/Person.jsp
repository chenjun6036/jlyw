...
//				collapsible:true,
		...
		function query(){
			 ...
			 $('#result').datagrid('options').queryParams={'EmployeeId':encodeURI($('#employeeid').combobox('getValue')),'StartTime':encodeURI($('#dateTimeFrom').datebox('getValue')),'EndTime':encodeURI($('#dateTimeEnd').datebox('getValue'))};
		...
		function myExport(){
			...
			var title = $('#dateTimeFrom').datebox('getValue') + "至" + $('#dateTimeEnd').datebox('getValue') + "员工" + employee + "业务量统计";
