...
<body>
<% 
			JSONObject ret=(JSONObject)request.getSession().getAttribute("PersonOutputList");	
...
%>
	...
	<div style="line-height:20px" align="center">
		<table style="background-color:#FFFFFF">
			<TR>
				<td align="center">
					<STRONG>
						<font color="#000000" size="5">个人产值明细表</font>
					</STRONG>
				</td>
			</TR>
		</table>
	...
	<div id="div1" style="background-color: #FFFFFF; color:#FFFFFF" >
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<TR>
				<TD width="23%" align="left" style="padding-left:20px" colspan="2"><font size="2" color="#000000">完工人工号：<%=ret.getString("UserId") %>&nbsp;&nbsp;&nbsp;&nbsp;<%=ret.getString("UserName") %></font></TD>
		...
		<table border=1 cellSpacing=0 cellPadding=1 width="100%" style="border-collapse:collapse;table-layout:fixed;" bordercolor="#000000">
			<thead>
				<tr height="40px">
					...
					<td width="4%" align="center"><font size="2">结账人</font></td>
			...
			%>
				<tr height="25px">
					...
					<td align="center"><font size="1"><%=ret.getJSONArray("rows").getJSONObject(i).getString("CheckOutStaff") %></font></td>
			...
			<%
				...
				request.getSession().removeAttribute("PersonOutputList");	
			%>
			</tbody>
		</table>
	</div>
	...
	<script language="javascript" type="text/javascript">
		...
		function Mytable(){
			...
			LODOP.ADD_PRINT_TEXT(55,450,400,30,"个人产值明细表");
