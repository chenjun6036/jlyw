...
<body>
<% 
			JSONObject ret=(JSONObject)request.getSession().getAttribute("CompanyMXList");	
...
%>
	...
	<div id="div2">
		<table border=1 cellSpacing=0 cellPadding=1 width="100%" style="border-collapse:collapse;table-layout:fixed;" bordercolor="#000000">
			...
			<%
				...
				request.getSession().removeAttribute("CompanyMXList");	
			%>
			</tbody>
		</table>
	</div>
	...
	<script language="javascript" type="text/javascript">
		...
		function Mytable(){
			...
			LODOP.ADD_PRINT_TABLE(130,"1%","98%",570,document.getElementById("div2").innerHTML);
			LODOP.SET_PRINT_STYLEA(0,"FontColor","#000000");
			
			LODOP.ADD_PRINT_HTM(85,"5%","90%",40,document.getElementById("div1").innerHTML);
