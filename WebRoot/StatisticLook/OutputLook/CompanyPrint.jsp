...
<body>
<% 
			JSONObject ret=(JSONObject)request.getSession().getAttribute("CompanyOutputList");	
...
%>
	...
	<div id="div2">
		<table border=1 cellSpacing=0 cellPadding=1 width="100%" style="border-collapse:collapse;table-layout:fixed;" bordercolor="#000000">
			<thead>
				<tr height="40px">
					<td width="12%" align="center"><font size="2">部门编码</font></td>
					<td width="12%" align="center"><font size="2">部门名称</font></td>
					<td width="12%" align="center"><font size="2">员工姓名</font></td>
					<td width="12%" align="center"><font size="2">工号</font></td>
					<td width="16%" align="center"><font size="2">产值</font></td>
					
					<td width="12%" align="center"><font size="2">台件数</font></td>					
					<td width="12%" align="center"><font size="2">退样数</font></td>
					<td width="12%" align="center"><font size="2">证书数</font></td>
			...
			%>
				<tr height="25px">
					<td align="center"><font size="2"><%=ret.getJSONArray("rows").getJSONObject(i).getString("DeptCode") %></font></td>
					<td align="center"><font size="2"><%=ret.getJSONArray("rows").getJSONObject(i).getString("DeptName") %></font></td>
			...
			<%
				...
				request.getSession().removeAttribute("CompanyOutputList");	
			%>
			</tbody>
		</table>
	</div>
	...
	<script language="javascript" type="text/javascript">
		...
		function Mytable(){
			...
			LODOP.ADD_PRINT_TABLE(110,"1%","98%",900,document.getElementById("div2").innerHTML);
			LODOP.SET_PRINT_STYLEA(0,"FontColor","#000000");
			
			LODOP.ADD_PRINT_HTM(80,"5%","90%",25,document.getElementById("div1").innerHTML);
			...
			LODOP.ADD_PRINT_TEXT(55,310,400,30,"全所产值表");
