	...
	<script>
		$(function (){
			...
			$('#table2').datagrid({
				...
				columns:[[
					{field:'num',title:'编号',width:100,align:'center'},
					{field:'CustomerName',title:'询价单位名称',width:180,align:'center',sortable:true},
					{field:'Contactor',title:'询价单位联系人',width:120,align:'center'},
					{field:'ContactorTel',title:'联系人电话',width:100,align:'center'},
					{field:'ContactorEmail',title:'联系人Email',width:100,align:'center'},
					
					{field:'CarCost',title:'交通费',width:80,align:'center'},
					{field:'OfferDate',title:'报价时间',width:80,align:'center',sortable:true},
...
//				url:'/jlyw/QuotationServlet.do?method=0',
		...
		$(function(){
			...
			$('#table4').datagrid({
				...
				columns:[[
					{field:'Xh',title:'序号',width:40,align:'center'},
...
<input id="filePath" name="filePath" type="hidden" />
 ...
 <DIV class="JlywMainLayoutDiv">
	...
	<DIV class="JlywCenterLayoutDIV">
		<div  align="center" style="width:800px;padding:10px" class="easyui-panel" title="查询条件" collapsible="false"  closable="false">
	   ...
	   <div style="+position:relative;">
		...
		<div id="quo_edit" class="easyui-window" title="修改报价单条目" style="padding:10px;width:480px;height:320px;"
		...
		<div id="add" class="easyui-window" title="添加报价单条目" style="width:480px;height:320px;padding:10px"
		iconCls="icon-edit" closed="true" maximizable="false" minimizable="false" collapsible="false" modal="true" >
