...
<TR>
  <td width="56%" align="right">
	<STRONG>
	<font color="#000000" size="4">费用详单</font>
	</STRONG>
  <td>
...
<thead >
  <TR>
    ...
    <TD width="13%" style="border-left:0;border-right:0; border-bottom:solid 1px; border-top:solid 1px">
      <DIV align=center><font size="2">证书号</font></DIV></TD>
 ...
 %>        
  <TR>
    ...
    <TD align="center"><font size="2"><%=ret.getJSONArray("rows").getJSONObject(i).getString("CertificateCode").length()>14?ret.getJSONArray("rows").getJSONObject(i).getString("CertificateCode").substring(0, 14):ret.getJSONArray("rows").getJSONObject(i).getString("CertificateCode") %></font></TD>
