...
private StandardApplianceDAO m_dao = new StandardApplianceDAO();
	...
	*/
	...
	public List<String> formatExcel(Object obj){
		...
		result.add(((StandardAppliance)obj).getSeriaNumber()==null?"":((StandardAppliance)obj).getSeriaNumber().toString());
		result.add(((StandardAppliance)obj).getManufacturer()==null?"":((StandardAppliance)obj).getManufacturer().toString());
		result.add(((StandardAppliance)obj).getReleaseDate()==null?"":((StandardAppliance)obj).getReleaseDate().toString());
		result.add(((StandardAppliance)obj).getReleaseNumber()==null?"":((StandardAppliance)obj).getReleaseNumber().toString());
