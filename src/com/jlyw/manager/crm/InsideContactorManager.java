 ...
 *
 */
public class InsideContactorManager {
private InsideContactorDAO m_dao=new InsideContactorDAO();
		/**
		 * 
		 */
		public InsideContactor FindById(int id)
		{
			return m_dao.findById(id);
		}
		
		public boolean save(InsideContactor customerfee){
		 ...
		 */
		public boolean update(InsideContactor c){
			Transaction tran = m_dao.getSession().beginTransaction();
			try {			
				m_dao.update(c);
				tran.commit();
		...
		public boolean deleteById(int id){
			Transaction tran = m_dao.getSession().beginTransaction();
			try {			
				InsideContactor u = m_dao.findById(id);
				if(u == null){
					return true;
				}else{
					m_dao.delete(u);
		 ...
		 * @return
		 */
		public List<InsideContactor> findByVarProperty(KeyValueWithOperator...arr){
			return m_dao.findByVarProperty("InsideContactor", arr);
		}
